...
u8_t s_state_buffer[BSEC_MAX_STATE_BLOB_SIZE];
s32_t s_state_buffer_len;
...
int env_sensors_init_and_start(void)
{
	...
	bsec_ret = bsec_iot_init(BSEC_SAMPLE_RATE_ULP, 1.2f, bus_write,
				bus_read, sleep, state_load, config_load);
